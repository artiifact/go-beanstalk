...
type Stats struct {
	...
	CmdReserve            int     `json:"cmdReserve" yaml:"cmd-reserve"`                         // is the cumulative number of reserve commands
	CmdReserveWithTimeout int     `json:"cmdReserveWithTimeout" yaml:"cmd-reserve-with-timeout"` // is the cumulative number of reserve-with-timeout commands
	...
	CmdUse                int     `json:"cmdUse" yaml:"cmd-use"`                                 // is the cumulative number of use commands
	...
	CmdTouch              int     `json:"cmdTouch" yaml:"cmd-touch"`                             // is the cumulative number of touch commands
